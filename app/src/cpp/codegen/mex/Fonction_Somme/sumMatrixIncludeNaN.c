...
real_T b_sumColumnB4(const emxArray_int32_T *x, int32_T vstart)
{
  real_T psum1;
  real_T psum2;
  real_T psum3;
  ...
  for (k = 0; k < 1023; k++) {
    int32_T psum1_tmp;
    psum1_tmp = vstart + k;
    psum1 += (real_T)x_data[psum1_tmp];
    psum2 += (real_T)x_data[psum1_tmp + 1024];
    psum3 += (real_T)x_data[psum1_tmp + 2048];
    psum4 += (real_T)x_data[psum1_tmp + 3072];
  }
                    ...
                    int32_T vlen)
{
  ...
  if (vlen <= 1024) {
    ...
    for (k = 2; k <= nfb; k++) {
      ...
      b_st.site = &be_emlrtRSI;
      for (b_k = 0; b_k < 1023; b_k++) {
        b_y += (real_T)x_data[(vstart + b_k) + 1];
      }
      y += b_y;
    }
    if (vlen > inb) {
...
real_T c_sumColumnB4(const emxArray_real_T *x, int32_T vstart)
{
  const real_T *x_data;
  real_T psum1;
  real_T psum2;
...
real_T d_sumColumnB(const emlrtStack *sp, const emxArray_int32_T *x,
                    int32_T vlen, int32_T vstart)
{
  emlrtStack b_st;
  emlrtStack c_st;
  ...
  if (vlen <= 1024) {
    ...
    for (k = 2; k <= nfb; k++) {
      ...
      b_st.site = &be_emlrtRSI;
      for (b_k = 0; b_k < 1023; b_k++) {
        b_y += (real_T)x_data[b_vstart + b_k];
      }
      y += b_y;
    }
    if (vlen > inb) {
...
real_T f_sumColumnB(const emlrtStack *sp, const emxArray_real_T *x,
                    int32_T vlen, int32_T vstart)
{
  emlrtStack b_st;
  emlrtStack c_st;
